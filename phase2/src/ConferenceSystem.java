...
public class ConferenceSystem {
    ...
    public static final String USER_DATA_PATH = "phase2/resources/userData.txt";
    public static final String MESSAGE_DATA_PATH = "phase2/resources/messageData.txt";
    public static final String EVENT_DATA_PATH = "phase2/resources/eventData.txt";
